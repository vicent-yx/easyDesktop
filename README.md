# EasyDesktop - 您的智能桌面伴侣

[![GitHub license](https://img.shields.io/github/license/codevicent/easy-desktop)](LICENSE)
[![Gitee stars](https://gitee.com/codevicent/easy-desktop/badge/star.svg?theme=white)](https://gitee.com/codevicent/easy-desktop/stargazers)

**隐藏桌面图标，但不隐藏便捷性！** EasyDesktop 是一款创新的桌面增强工具，让您在保持桌面整洁美观的同时，快速访问桌面文件。只需将鼠标移至屏幕左下角，即可呼出智能文件面板！

![主界面](https://gitee.com/codevicent/easy-desktop/raw/main/README_RES/main.jpg)
...
| 动态效果 | 说明 |
|----------|------|
| ![自定义背景](https://gitee.com/codevicent/easy-desktop/raw/main/README_RES/bg_set.gif) | 自定义背景与磨砂效果 |
| ![文件搜索](https://gitee.com/codevicent/easy-desktop/raw/main/README_RES/search_show.gif) | 智能文件搜索演示 |
| ![主题切换](https://gitee.com/codevicent/easy-desktop/raw/main/README_RES/sys_theme.gif) | 系统主题跟随演示 |
