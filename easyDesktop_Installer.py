...
def install():
    ...
    try:
        ...
        filename = resource_path(os.path.join("res","ed_pack.zip"))
        ...
        target_path = os.path.join(install_path,r"easydesktop\easyDesktop.exe")
...
def closeWindow():
    ...
    window.quit()
have_network=False
install_path = "C:/Program Files/easydesktop"
...
path_v.set("C:/Program Files/easydesktop")
